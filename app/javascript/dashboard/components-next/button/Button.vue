...
const STYLE_CONFIG = {
  colors: {
    blue: {
      solid:
        'bg-gradient-to-b from-n-blue-9 to-n-brand text-white shadow-brand hover:enabled:-translate-y-px hover:enabled:brightness-110 focus-visible:brightness-110 outline-transparent',
      faded:
  ...
  base: 'inline-flex items-center min-w-0 gap-2 transition-all duration-150 ease-out border-0 rounded-xl outline-1 outline shadow-soft disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-n-brand/40',
};
